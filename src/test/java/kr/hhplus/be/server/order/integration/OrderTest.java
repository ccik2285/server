...
import kr.hhplus.be.server.infrastructure.goods.GoodsRepository;
...
@SpringBootTest
@Sql(statements = "INSERT INTO goods (goods_no, goods_state_cd, goods_nm, stock_quantity, sale_price) VALUES (1, 'ON_SALE', 'Test Goods', 100, 1000)")
public class OrderTest {
    ...
    private Long availableStock = 3L;
        ...
        for (int i = 0; i < 5; i++) {
            executor.submit(() -> {
                try {
                    ...
                    System.out.println("hello + " + orderNo);
