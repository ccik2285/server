...
public class GetGoodsListUseCase {
    ...
    public GetGoodsListUseCase(GoodsRepositoryCustom goodsRepositoryCustom) {
        this.goodsRepositoryCustom = goodsRepositoryCustom;
    }

    public Page<GoodsPageResponse> execute(int page, int size) {
        Pageable pageable = PageRequest.of(page, size);
        return convertToDtoPage(goodsRepositoryCustom.findGoodsList(pageable));
    }
